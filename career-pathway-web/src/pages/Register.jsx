...
import './Login.css'; // Shares glassmorphism styling with Login page
...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      // 2. Store Student Document in Firestore
      const studentData = {
        uid: user.uid,
    ...
    <div className="login-container">
      ...
      >
        ...
        <div className="login-footer">
          <p>Already have an account? <Link to="/login" className="linkText">Sign In</Link></p>
        </div>
      </motion.div>
    </div>
  );
