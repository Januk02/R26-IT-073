...
const QUESTIONS = [
  ...
  },
  {
    id: 6,
    domain: "Expectations",
    questions: ["What do you expect from a mentee?"],
  },
  {
    id: 7,
    domain: "Adaptability",
  ...
  },
  {
    ...
    questions: ["What would you do if a mentee disagreed with your advice?"],
  },
];
      ...
      <div className="max-w-3xl w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="bg-gray-50 rounded-xl p-6 border border-gray-200 mb-6">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            >
              <div
                className={`w-3 h-3 rounded-full ${isRecording ? "bg-red-200 animate-pulse" : "bg-white"}`}
              ></div>
        ...
        <div className="flex justify-between">
          <button
            ...
            disabled={currentQuestionIndex === 0 || isSubmitting || isAnalyzing}
